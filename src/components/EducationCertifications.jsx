  ...
  const certifications = [
    {
      ...
      meta: "Credential ID: 322304644OCI25AICFA"
    },
    {
    ...
    },
    {
      ...
      meta: "Open source contributions to core repositories"
    }
  ];
        ...
        <TiltCard isZeroG={isZeroG} className="bg-white/5 border border-white/10 rounded-2xl h-full flex flex-col justify-between">
          <div className="text-left space-y-6">
            ...
            <div className="space-y-4">
              <div>
                <span className="text-[10px] font-mono text-[#06b6d4] uppercase tracking-wider block font-semibold">2021 - 2025</span>
                <h4 className="text-base font-bold text-white mt-1">BE in Artificial Intelligence & Data Science</h4>
                <p className="text-xs text-slate-400 font-mono">SDM Institute of Technology</p>
              </div>

              <ul className="space-y-2.5 text-xs text-white/70 list-none">
                ...
                <li className="flex gap-2 items-start font-sans leading-relaxed">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#06b6d4] mt-1.5 flex-shrink-0" />
                  <span>Represented the varsity football and volleyball teams.</span>
                </li>
                <li className="flex gap-2 items-start font-sans leading-relaxed">
                  <span className="w-1.5 h-1.5 rounded-full bg-[#06b6d4] mt-1.5 flex-shrink-0" />
                  <span>Volunteer with the National Service Scheme (NSS).</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div className="text-left space-y-6">
            ...
            <div className="space-y-4">
              {certifications.map((cert, index) => (
                <div key={index} className="flex gap-3 items-start border-b border-white/5 pb-3 last:border-b-0 last:pb-0">
